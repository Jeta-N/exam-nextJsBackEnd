...
namespace examNextJsBackEnd.Entities.Migrations
{
    ...
    [Migration("20230417041744_add-seeding-restaurant")]
    partial class addseedingrestaurant
    {
            ...
            modelBuilder.Entity("examNextJsBackEnd.Entities.Restaurant", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTimeOffset(new DateTime(2023, 4, 17, 4, 17, 44, 427, DateTimeKind.Unspecified).AddTicks(4139), new TimeSpan(0, 0, 0, 0, 0)),
                            Name = "McDonalds"
                        },
                        new
                        {
                            Id = "01GY6PXNZBB0JSS61Q2JDBBJJJ",
                            CreatedAt = new DateTimeOffset(new DateTime(2023, 4, 17, 4, 17, 44, 427, DateTimeKind.Unspecified).AddTicks(4142), new TimeSpan(0, 0, 0, 0, 0)),
                            Name = "KFC"
                        });
                });
